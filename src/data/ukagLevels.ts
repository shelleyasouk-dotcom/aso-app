...
export const UKAG_LEVELS: UKAGLevel[] = [
...

  {
    ...
    coachingGuide: {
      intro: 'Level 4 gymnasts are developing real technique and independence. The challenge is linking skills smoothly, increasing power, and handling more complex apparatus work. Your coaching should push them technically while keeping confidence high. This is when gymnastics starts to feel like gymnastics.',
      techniques: [
        { title: 'Sequence Coaching', detail: 'Teach skills in pairs and triples: "forward roll — straight to standing." Build a 3-skill sequence and practice the transitions as much as the skills themselves.' },
        { title: 'Rhythm and Counting', detail: 'For hip circles, swings, and round-offs, use rhythm cues: "one — push — block" or count beats aloud. Rhythm makes power consistent and safer.' },
        { title: 'Reduce Support Systematically', detail: 'Track what support level each gymnast is at per skill. Each week, aim to remove one level of support deliberately — full hold → one hand → hover → free.' },
        { title: 'Video Feedback', detail: 'Even a 10-second phone clip can transform a gymnast\'s understanding. "Did your arms look straight? Watch it back — now try again." Use it specifically for technique correction.' },
        { title: 'Set Micro-Goals Each Session', detail: 'Give every gymnast one personal target at the start: "Today your goal is pointed toes on the cartwheel." End with: "Did you hit it?"' },
      ],
      supportIdeas: [
        'Back walkovers: stand to the side, support the lower back with one hand and guide the kick leg gently upward with the other. Do not push through the hip.',
        'Hip circles: stand behind, both hands on hip bones, guide the full rotation. Step back after 2 assisted reps.',
        'Round-off: walk alongside with a hand at the waist — the key is staying with the gymnast through the rotation.',
        'Vault handsprings: a crash mat landing stack gives gymnasts the sensation of commitment without consequence.',
        'Beam cartwheels: use a low beam and spot from the landing side, not the kick side.',
        'Use a confidence bridge — spot 3 times, hover 3 times, step back 3 times — gymnast knows each stage.',
      ],
      coachingAids: [
        { name: 'Incline / Cheese Mat', purpose: 'Back walkovers and bridges — reduces spine loading while building range of motion and shoulder confidence.' },
        { name: 'Crash Mat Stack (raised landing)', purpose: 'Raise the landing surface for vault and floor aerials — allows gymnasts to commit without fear of under-rotation.' },
        { name: 'Resistance Band', purpose: 'Ankle and shoulder flexibility in warm-up. Also useful for core activation before hip circles.' },
        { name: 'Spot Belt', purpose: 'For early round-off or back handspring drills — gives gymnast full safety while coach maintains control of rotation.' },
        { name: 'Adjustable Springboard', purpose: 'Lower or raise the platform height to manage difficulty and confidence on vault approaches.' },
      ],
      whatToWatch: [
        'Over-arching in back walkovers — bending at the lower back rather than the thoracic spine. Use bridge prep and shoulder flexibility work.',
        'Head tucked in hip circles — gymnast should be looking slightly forward, not down, as they pass over the bar.',
        'Rushing the round-off — the take-off foot is not landing correctly. Slow the approach and focus on the hurdle step.',
        'Feet apart on vault landings — reinforce "heels together, soft bend, Block and Present."',
        'Loss of body tension between linked skills — they look separate, not connected. Use rhythm cues to link them.',
        'Plateau on a skill for 3 sessions — try a completely different drill approach rather than repeating the same one.',
      ],
      howToDevelop: [
        'Progress walkovers: bridge hold → bridge kick-over on mat → walkover on incline → floor walkover (spotted) → independent.',
        'Progress hip circles: swings → up-hip circle → cast to front support → back hip circle.',
        'Progress round-off: hurdle step → cartwheel to two feet → cartwheel turn → round-off drill → full round-off.',
        'Progress vault: handspring flat-back on stack → reduce stack → full handspring with spot → independent.',
        'Progress beam: mount, 3 skills, dismount sequence — rehearse the full sequence 3 times every session.',
      ],
      motivationTips: [
        '"You have done the hard part — you know what it feels like. Now let\'s do it without my hand."',
        'Frame challenges positively: "This is a hard skill. That means when you get it, it really means something."',
        '"Name your goal for today — at the end of class we\'ll see if you hit it."',
        'Use a skills board where gymnasts tick off achievements each session.',
        'Encourage gymnasts to coach each other — peer observation is powerful at Level 4.',
      ],
    },
  },

  {
    ...
    coachingGuide: {
      intro: 'Level 5 introduces flight, power, and advanced acrobatics. Your coaching must balance technical precision with safety management. Gymnasts at this level need both a skilled spotter and growing self-awareness. The relationship between coach and gymnast becomes a genuine partnership built on trust.',
      techniques: [
        { title: 'Power Phase Coaching', detail: 'Break flight skills into distinct phases: "Run — Hurdle — Block — Flight — Land." Coach each phase individually before linking them. Never rush to the full skill.' },
        { title: 'Verbal Anchors', detail: 'Use a consistent short phrase for each skill that gymnasts can say to themselves: "Jump — reach — snap — present." Internalized cues reduce reliance on coach direction during performance.' },
        { title: 'Fear Management', detail: 'Acknowledge fear openly: "This feels scary — that is normal. Let\'s break it into smaller steps." Never dismiss it. Address it systematically with progressive drill reductions.' },
        { title: 'Strength Conditioning Micro-Sets', detail: 'Incorporate 5 minutes of targeted conditioning — hollow holds, shoulder presses, wrist strength. Level 5 gymnasts need adequate strength to perform skills safely and consistently.' },
        { title: 'Self-Coaching Prompts', detail: 'After a skill, ask "what did you feel?" before giving feedback. This builds body awareness and teaches gymnasts to diagnose their own errors.' },
      ],
      supportIdeas: [
        'Back handspring: two-arm support at the waist. Step forward with the gymnast, rotate your body through the skill alongside them. Never support from the front.',
        'Handspring vault: crash mat stack for first 10 reps. Step-in support at the hip once gymnast commits to the block phase.',
        'Back walkover: hand under lower back, second hand guides the kick leg gently upward through the full rotation.',
        'Front tuck on trampette: spot from the side with one hand on the upper back and one at the hip. Maintain contact through rotation.',
        'Clear hip circle: both hands on hips from behind — support full rotation until gymnast develops cast height and timing independently.',
        'Reduce physical spotting by using crash mat stacks rather than body contact as confidence grows.',
      ],
      coachingAids: [
        { name: 'Trampette', purpose: 'Essential for vault and flight skill progressions. Use for front tuck, back tuck, and handspring awareness work.' },
        { name: 'Thick Crash Mat', purpose: 'Raise all aerial landing zones. Gymnasts should land on a raised crash mat for the first 10–20 reps of any new flight skill.' },
        { name: 'Spotting Belt', purpose: 'For round-off back handspring and front tuck — allows coach to control rotation fully while gymnast commits fully to the movement.' },
        { name: 'Incline / Cheese Mat', purpose: 'Bridge to kick-over and back walkover prep — reduces spinal load and builds confidence in backwards weight transfer.' },
        { name: 'Resistance Bands', purpose: 'Shoulder and wrist mobility for handspring block preparation. Also core strength loading in hollow holds.' },
      ],
      whatToWatch: [
        'Block timing on handspring vault — gymnast is pushing after peak rather than on contact. The push must be explosive and immediate on contact.',
        'Head thrown back in back handspring — causes dangerous over-rotation and inconsistent landings. Cue: "Eyes on your hands."',
        'Loss of body tension at the top of a handspring — gymnast opens too early. Use hollow body drill work to fix this.',
        'Over-rotation on front tuck — gymnast is pulling the tuck too quickly. "Jump for height first — tuck second."',
        'Shaking in clear hip circles — insufficient cast height. Return to cast drills before progressing the circle.',
        'Gymnasts attempting flight skills without coach present — establish a firm "no flight skills without a spotter" rule.',
      ],
      howToDevelop: [
        'Progress back handspring: bridge kick-over → round-off (solid) → round-off to crash mat → round-off back handspring (belt) → round-off back handspring (hand spot) → independent.',
        'Progress handspring vault: flat-back to crash mat stack → lower stack → full handspring with spot → independent.',
        'Progress front tuck: straight jump (trampette) → jump and tuck knees only → full tuck rotation → controlled landing.',
        'Progress clear hip: cast to 45° → cast to horizontal → clear hip (supported) → independent.',
        'Progress walkovers: fully spotted → remove one hand → independent.',
      ],
      motivationTips: [
        '"This is a Level 5 skill. You are working at the top of the UKAG programme — that is a big deal."',
        'Document progress — photos or a progress sheet so gymnasts can see how far they have come over the semester.',
        '"I spotted you 5 times last week. Today: 3 times. Next week: 1."',
        'Give gymnasts the language to describe what they are doing: "What phase of the handspring was that?"',
        'Celebrate mastery out loud to the group — peer recognition is incredibly motivating at this age.',
      ],
    },
  },
  {
    ...
    coachingGuide: {
      intro: 'Level 6 is the highest UKAG level. Gymnasts here are developing high-level acrobatic skills, routine construction, and performance quality. Coaching at this level requires advanced spotting skills, knowledge of biomechanics, and the ability to develop the gymnast as an athlete — not just a skill performer.',
      techniques: [
        { title: 'Biomechanical Cueing', detail: 'Use precise anatomical language: "Drive through your shoulders, not just your arms." "Pull your hips to the ceiling, not your knees." Precision language creates precision movement.' },
        { title: 'Routine Construction', detail: 'Teach gymnasts to build routines with intention: mount, travel, balance or inversion, leap or jump, dismount. Every element should have a purpose and a connection to the next.' },
        { title: 'Video Analysis', detail: 'At Level 6, video is a genuine coaching tool. A 10-second clip per session for a key skill lets gymnasts compare what they feel versus what they see — transformative for self-correction.' },
        { title: 'Performance Mindset', detail: '"Perform" rather than "attempt" — talk about how the skill looks to an audience. Introduce presentation, eye contact, and flow between elements as coaching targets.' },
        { title: 'Coach the Athlete, Not Just the Skill', detail: 'Understand each gymnast\'s personal goals, strengths, and mental blocks. Individualise session targets and celebrate their identity as a gymnast, not just their output.' },
      ],
      supportIdeas: [
        'Aerial cartwheel: spot from the side — one hand at the waist, one at the hip. Step through the take-off alongside the gymnast.',
        'Round-off back tuck: stand at the side, one arm under the upper back and shoulders — rotate to maintain contact through the flip.',
        'Back tuck from platform: raise the platform so gymnast lands at hip height, then progressively lower as height and rotation improve.',
        'Upstart on bars: stand beside the bar, hands on the hips — guide the gymnast through the pull-to-support phase.',
        'Full pirouette on floor: spot the shoulder and guide the axis of rotation.',
        'Never spot aerial skills alone without confidence. Use an assistant and crash mats stacked appropriately.',
      ],
      coachingAids: [
        { name: 'Tumble Track or Sprung Floor', purpose: 'If available, dramatically reduces impact for high-skill repetition (round-off back tuck, aerials). Use when accessible for intensity blocks.' },
        { name: 'Thick Crash Mat and Platform', purpose: 'For back tuck and front tuck progressions from height — allows gymnasts to find the landing safely before reducing the stack.' },
        { name: 'Spotting Belt', purpose: 'For twisting elements or early back tuck series. Coach must be trained in correct belt use before deploying for flight skills.' },
        { name: 'Video or Tablet', purpose: 'At Level 6 a 10-second playback transforms gymnast self-awareness. Use specifically for flight skill technique correction sessions.' },
        { name: 'Resistance Bands and Conditioning Tools', purpose: 'Shoulder pre-hab for bar skills, hip flexor activation for vault, and core conditioning for aerial elements.' },
      ],
      whatToWatch: [
        'Loss of tension in aerials — gymnast opens shape mid-flight. Hollow body conditioning is the primary fix.',
        'Head thrown back in back tuck — causes over-rotation. "Eyes forward until you feel the peak — then tuck."',
        'Feet apart on round-off — this bleeds power from the take-off. The hurdle and block must be one clean, efficient action.',
        'Dropping the chest on bar upstart — gymnast is not using the lat pull. Strengthen the bar pull drill specifically.',
        'Walking off after flight skills — enforce a "stick it" rule: no movement until both feet are still and arms are up.',
        'Overtraining flight reps — at this level, fatigue leads to form breakdown and injury risk. Cap flight reps at 6–8 per session maximum.',
      ],
      howToDevelop: [
        'Progress round-off back tuck: round-off to crash mat → round-off back handspring → round-off back tuck (spot) → crash mat at lower height → independent.',
        'Progress aerial cartwheel: cartwheel with one hand → fingertips only → no-hand attempt over crash mat → aerial with spot → independent.',
        'Progress upstart: kip swing drills → pull to horizontal → upstart (supported) → independent.',
        'Progress vault handspring half-turn: handspring flat-back → add half-turn on crash mat → reduce stack → independent.',
        'Routine development: build a floor routine over 3 sessions — opening tumble, linking leaps, final tumble pass, dismount.',
      ],
      motivationTips: [
        '"You are at the top of the UKAG programme. What you are doing is genuinely advanced gymnastics."',
        'Set long-term goals across the full semester alongside weekly session targets.',
        '"Which skill do you most want to crack this semester? Let\'s build a plan together."',
        'Encourage gymnasts to lead warm-ups or demonstrate to younger groups — this builds pride and responsibility.',
        'Acknowledge the mental strength required: "Doing that took courage as much as skill."',
      ],
    },
  },
]

        ...
        <Section number="6" title="Collection and Dismissal">
          ...
          <SubSection title="6.2 Late Collection">
            ...
            <ol className="list-decimal list-inside space-y-1 text-sm text-gray-600">
              ...
              <li>Contact the Senior Lead for further guidance</li>
            </ol>
          ...
          <SubSection title="6.3 No Self-Dismissal">
            <p className="text-sm text-gray-600 leading-relaxed">Children will not be permitted to leave the session unaccompanied, regardless of age, unless written permission has been provided in advance and agreed by the Senior Lead and school.</p>
          </SubSection>
        </Section>

...
import { CheckCircle, Lock, Clock, ChevronRight, Award, GraduationCap } from 'lucide-react'
...
export function LeadershipCoursePage() {
  ...
  return (
    <Layout title="Leadership Course" showBack>
      <div className="flex flex-col gap-4 pb-10">

        {/* Header */}
        <div className="bg-gradient-to-br from-[#1a3a6b] to-[#1e4a8c] text-white px-4 pt-5 pb-6">
          ...
          {loading ? (
            ...
            course.modules.map((mod, index) => {
              ...
              return (
                <button
                  key={mod.id}
                  onClick={() => unlocked && navigate(`/course/leadership/${mod.id}`)}
                  disabled={!unlocked}

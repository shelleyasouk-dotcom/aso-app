...
export function MyAreaPage() {
  ...
  const personalTiles: Tile[] = [
    ...
    { label: 'My Payslips', description: 'Monthly pay & earnings statements', icon: Wallet, path: '/my-payslips', color: 'bg-indigo-50 text-indigo-700' },
  ...
  const juniorCoachTiles: Tile[] = [
    ...
    ...(role === 'assistant_coach' ? [{ label: 'Incident Reports', description: 'Log accidents & incidents', icon: ShieldAlert, path: '/incidents', color: 'bg-red-50 text-red-700' }] : []),
  ]

    ...
    <div className="min-h-screen bg-[#f4f6f9]">
      ...
      <div className="px-4 py-5 flex flex-col gap-3 pb-12">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-4 py-4">
          ...
          <p className="text-xs text-gray-500 mt-2">If something isn't covered here, ask your Lead Coach or Senior Lead before making a decision. Never guess when it comes to safety or safeguarding.</p>
        </div>
        ...
        <Section icon={Users} title="Section 2 — Your Role" subtitle="4 roles, one pathway">
          ...
          <div className="flex flex-col gap-2 mt-2">
            ...
            <RoleRow role="Senior Lead" age="18+" pay="Agreed rate" desc="Oversee multiple schools, manage coaches, quality assurance." />
          </div>
        ...
        <Section icon={ClipboardList} title="Section 3 — Before Your First Session" subtitle="Complete before you can work with us">
          ...
          {[
            ...
            'Signed off by your Lead Coach or Senior Lead',
          ...
          <Warn text="You may not attend a session independently until every item above is ticked and confirmed by your Senior Lead." />
        </Section>
        ...
        <Section icon={MapPin} title="Section 5 — Arrival and Set-Up" subtitle="Arrive 10 minutes early — no exceptions">
          ...
          <Warn text="If something is wrong with the space (wet floor, damaged equipment, no supervision possible) — do not start the session. Call your Lead Coach or Senior Lead immediately." />
        </Section>
        ...
        <Section icon={ClipboardCheck} title="Section 6 — Register and Attendance" subtitle="A safeguarding document — never skip it">
          ...
          <Step n={5} text="Submit the register to Naima or your Senior Lead within 24 hours of the session" />
          <SubHeading text="If a Child Arrives Who Is Not on the Register" />
          <Bullet text="Do not turn them away" />
          <Bullet text="Contact your Senior Lead immediately" />
          <Bullet text="Record their name, time of arrival, and who brought them" />
          <Bullet text="Do not allow them to participate until you have confirmation from the Senior Lead" />
        </Section>
        ...
        <Section icon={AlertTriangle} title="Section 7 — Medical Awareness & Snack Protocol" subtitle="Non-negotiable — read carefully">
          ...
          <Bullet text="Then notify the Senior Lead and parent without delay" />
          ...
          {[
            ...
            { situation: 'Child has a reaction during session', action: 'Use epi-pen if prescribed. Call 999. Call Senior Lead. Call parent.' },
        ...
        <Section icon={LogOut} title="Section 8 — End of Session and Dismissal" subtitle="One of the highest-risk parts of the session">
          ...
          <Step n={5} text="If someone is collecting who is not on the list, call the Senior Lead before releasing the child" />
        ...
        <Section icon={CalendarX} title="Section 9 — Absence and Cover" subtitle="Always before 9am — not by text">
          ...
          <Step n={4} text="If no cover is found within one hour, the Lead Coach contacts the Senior Lead" />
          <Step n={5} text="The Senior Lead contacts Naima if still unresolved by 12:00pm" />
          <Step n={6} text="Naima will inform the school and parents if the session cannot go ahead" />
          <Note text="If you cannot reach your Lead Coach within 30 minutes, go directly to the Senior Lead." />
          <SubHeading text="Rules Around Absence" />
          <Bullet text="One unplanned absence per term is understandable — life happens" />
          <Bullet text="Two or more unplanned absences in a term will trigger a review with your Senior Lead" />
          ...
          <Bullet text="Planned absences must be logged with your Lead Coach and Senior Lead in writing" />
        </Section>
        ...
        <Section icon={Timer} title="Section 10 — Logging Your Hours" subtitle="Submit by 5th, paid by 15th">
          ...
          <Info text="Current system: Monthly Timesheet Template (moving to online logging in 2026). Templates are available from Naima or your Senior Lead." />
        ...
        <Section icon={MessageSquare} title="Section 11 — Communication Standards">
          ...
          <Bullet text="If a teacher raises a concern, listen, thank them, and report it to your Senior Lead the same day" />
        ...
        <Section icon={Clock} title="Section 12 — Late Pickup Protocol" subtitle="Child not collected after 15 minutes">
          ...
          <Step n={5} text="If still no answer after two attempts, call your Senior Lead immediately" />
          <Step n={6} text="The Senior Lead will contact Naima and follow the school's late collection policy" />
          ...
          <Warn text="Never leave a child unattended. Never take a child off the school premises. When in doubt, call the Senior Lead." />
        </Section>
        ...
        <Section icon={Shield} title="Section 13 — Safeguarding & Photography" subtitle="Every coach's responsibility, every session · Updated June 2026">
          ...
          <Step n={5} text="Report it to your Lead Coach or Senior Lead immediately after the session" />
          <Step n={6} text="Complete the Safeguarding Concern Form the same day" />
          <Step n={7} text="The Senior Lead will escalate to the Designated Safeguarding Lead (DSL)" />
          <Warn text="If a child is in immediate danger — call 999 first. Then notify your Senior Lead." />

          <SubHeading text="13.3 — Photography & Images" />
          <Info text="Updated June 2026 — all staff must read and acknowledge this section." />
          <p className="text-sm text-gray-700 pt-1">Parents give photo consent at enrolment covering ASO marketing and social media. All staff can see a child's consent status in the register. Check before taking any photos — ask your Lead Coach or Senior Lead if unsure.</p>
          ...
          <Step n={1} text="Confirm with your Senior Lead that photography is approved for this session" />
          <Step n={2} text="Check consent status for every child — ask your Lead Coach or Senior Lead if unsure" />
          ...
          <Bullet text="If your Senior Lead has given written approval to use your personal phone for a specific session:" />
          ...
          <Note text="Say: 'I'll pass that on — our team will be able to help.' Then tell your Senior Lead. Do not share anything directly." />

          <SubHeading text="If Something Goes Wrong" />
          <Bullet text="Lost or stolen device — tell your Senior Lead the same day; they will notify the DSL; complete an Incident Report on the app" />
          <Bullet text="Photo taken of wrong child — delete it immediately from all devices; tell your Lead Coach or Senior Lead the same day; do not share it" />
          <Bullet text="Someone else taking photos that concern you — do not confront them; report to your Senior Lead after the session; if a child is at immediate risk — tell school staff and call 999" />
        ...
        <Section icon={Heart} title="Section 14 — Additional Needs Policy" subtitle="Inclusive coaching for every child">
          ...
          <Step n={2} text="If additional needs are noted, speak to your Senior Lead before the session begins" />
          <Step n={3} text="Your Senior Lead will brief you on any specific adjustments or strategies agreed with the parent" />
          <Step n={4} text="Do not make assumptions — every child is different" />
          <Note text="If a child arrives and you become aware of additional needs that were not disclosed, note it and report to your Senior Lead the same day." />
          ...
          <Info text="If a child's needs cannot be safely met within our current structure, the Senior Lead will speak honestly with the parent and explore alternative options." />
          ...
          <Bullet text="The arrangement has been agreed in advance by the Senior Lead" />
          ...
          <Bullet text="Making promises to parents about what support you can provide — refer to the Senior Lead" />
        ...
        <Section icon={Star} title="Section 15 — Uniform and Appearance" subtitle="You represent ASO at every session">
          ...
          <Note text="If your uniform is damaged or lost, report it to your Senior Lead. Do not turn up out of uniform without flagging it first." />
        </Section>
        ...
        <Section icon={TrendingUp} title="Section 16 — Your Development" subtitle="We invest in our coaches">
          ...
          <div className="flex items-center gap-1.5 flex-wrap mt-1">
            {['Junior Coach (13–16)', '→', 'Assistant Coach (16–18)', '→', 'Lead Coach (18+)', '→', 'Senior Lead'].map((item, i) => (
              item === '→'
          ...
          <Note text="Termly reviews are conducted by your Senior Lead. These are not disciplinary — they are designed to support your growth and identify your next steps." />
        </Section>
        ...
        <Section icon={CheckCircle} title="Section 17 — Conduct and Expectations">
          ...
          <Bullet text="Ignoring messages from your Lead Coach or Senior Lead" />
          ...
          <Step n={2} text="Written feedback from the Senior Lead" />
        ...
        <Section icon={User} title="Section 18 — Lone Working & Busy Sessions" subtitle="Safety · Calm · Positive experience">
          ...
          <Warn text="If a session becomes unsafe and cannot be managed alone, stop the activity, bring children to a seated position, and call your Senior Lead immediately. Do not continue under unsafe conditions." />
        ...
        <Section icon={BookOpen} title="Quick Reference Card" subtitle="What to do when things happen">
          {[
            ...
            { s: "I can't reach my Lead Coach", a: 'Call the Senior Lead directly — do not wait' },
            { s: 'A child says something worrying', a: 'Listen. Don\'t promise confidentiality. Report to Lead Coach → Senior Lead → DSL same day' },
            { s: "A child isn't collected after 15 mins", a: 'Stay with child. Check register. Call parent. If no answer → Senior Lead' },
            { s: 'A child has a medical reaction', a: 'Use epi-pen if prescribed. Call 999. Call Senior Lead. Call parent. Log it.' },
            { s: 'A parent makes a complaint', a: 'Thank them. Refer to Lead Coach or Naima. Do not make promises.' },
            { s: 'Equipment is damaged or unsafe', a: 'Do not use it. Report to Senior Lead before the session starts.' },
            ...
            { s: 'I want to progress my coaching', a: 'Speak to your Senior Lead about the UKAG pathway' },
            { s: 'A child arrives not on the register', a: 'Do not turn them away. Call Senior Lead. Record everything.' },
            { s: 'Something unsafe in the venue', a: 'Do not start the session. Call Senior Lead immediately.' },

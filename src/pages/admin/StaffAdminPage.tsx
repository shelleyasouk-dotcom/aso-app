...
const AREA_LEAD_VISIBLE_ROLES: Role[] = ['senior_lead_coach', 'lead_coach', 'assistant_coach', 'junior_coach']

const AREAS = ['Hampshire', 'Wiltshire', 'Dorset', 'Bath and North East Somerset', 'Oxfordshire']
const ROLES: Role[] = [
  'director', 'operations_manager', 'operations_assistant',
  'area_lead', 'senior_lead_coach', 'lead_coach', 'assistant_coach', 'junior_coach',
  'outreach_worker', 'marketing_assistant', 'media_tech',
]

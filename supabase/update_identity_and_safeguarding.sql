...
SET
  ...
  content_json = $j${
    ...
    "blocks": [
      ...
      {"id":"21","order":21,"type":"cta_button","label":"Create your UKAG profile","route":"https://www.ukacademiesofgymnastics.com/"},
      ...
      {"id":"24","order":24,"type":"cta_button","label":"Update my Compliance record","route":"/profile?tab=compliance"},
      {"id":"25","order":25,"type":"cta_button","label":"Upload my safeguarding certificate","route":"/profile?tab=documents"},
